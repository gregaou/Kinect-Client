 ...
 *
 * Contains a buffer for color data streamed out of a Kinect.
 * The frames are sent as JPG images.
 */
...
class ColorImageFrame : public ImageFrame
{
	public:
		 ...
		 * \param pixelData Buffer containing the pixel data (in JPG format)
